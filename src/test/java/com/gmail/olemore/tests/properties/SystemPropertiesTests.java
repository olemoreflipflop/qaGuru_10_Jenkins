package com.gmail.olemore.tests.properties;
...
public class SystemPropertiesTests {
    ...
    void someTest4() {
        System.setProperty("browser", "safari");
        String browser = System.getProperty("browser", "opera"); // по умолчанию опера, но установлено сафари
        System.out.println(browser); //сафари
    }
